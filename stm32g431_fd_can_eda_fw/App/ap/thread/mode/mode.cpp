...
bool modeThreadUpdate(void)
{
  ...
  // Mode Button Process
  //
  ret = buttonEventGetPressed(&btn_evt, EXHW_BUTTON_CH_S2);
  if (ret == true)
  {
...
void modeThreadISR(void *arg)
{
  ...
  {
    case MODE_USB_TO_CAN:
      ledOn(EXHW_LED_CH_CAN);
      ledOff(EXHW_LED_CH_RS485);
      break;

    case MODE_USB_TO_RS485:
      ledOff(EXHW_LED_CH_CAN);
      ledOn(EXHW_LED_CH_RS485);
      break;
